...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/14 21:58:55 by ashamurz          #+#    #+#             */
/*   Updated: 2022/10/15 03:06:47 by ashamurz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_right(t_game *solong)
{
	...
	else if (solong->map[solong->x_pos][solong->y_pos] == '0')
	{
		...
		ft_collect_case_right(solong);
	solong->the_character = mlx_xpm_file_to_image(solong->mlx_point, solong->character_r,
			&solong->he, &solong->wi);
